...
<html>
		...
		<div class="container">
			<div class="cabecalho bgGradient">
				<div class="text-center textCabecalho_White opacidade">
					<h3><strong>CADASTRAR FORNECEDOR</strong></h3>
				</div>
			</div>
				...
				<div class="mx-auto">
					<form id="frmFornecedor">
						<div>
							...
							<!-- COMPLEMENTO -->
							<div class="mcol-md-6 col-sm-6 col-xs-6 itensFormulario">
								<div>
	...
	<script type="text/javascript">
		$(document).ready(function($) {
			...
			$(".cep").change(function(){
				var cep = frmFornecedor.cep.value;
        ...
        $('#btnCadastrar').click(function() {
				var nome = frmFornecedor.nome.value;
				var cpf = frmFornecedor.cpf.value;
				var cnpj = frmFornecedor.cnpj.value;
				var celular = frmFornecedor.celular.value;
